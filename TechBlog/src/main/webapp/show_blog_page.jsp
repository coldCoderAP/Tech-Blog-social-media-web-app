...
%>
<!--  
when you click read more  BUTTON
-->
<%
...
<head>
<meta charset="UTF-8">
<title><%=p.getpTitle()%> || Tech blog by Learn code with
	atharva.</title>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="profile.jsp"><span
						class="fa fa-bell-o"></span>Learn Code With Atharva<span
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">Programing languages</a> <a
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="container text-center">
					<img src="pics/<%=user.getProfile()%>" class="imf-fluid "
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="add-post-form" action="AddPostServlet" method="post">
					...
					<div class="form-group">
						<textarea name="pContent" style="height: 150px"
							placeholder="Enter your content" class="form-control"> </textarea>
					</div>
					<div class="form-group">
						<textarea name="pCode" style="height: 150px"
